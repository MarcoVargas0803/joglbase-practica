...
public class TJOGL2 extends GLJPanel implements GLEventListener, KeyListener {
    ...
    final float[] colorLightYellow = {1.0f, 1.0f, 0.0f, 1.0f};
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] diffuseLight = {1.0f, 1.0f, 1.0f, 1.0f};  // multicolor diffuse 
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_DIFFUSE, diffuseLight, 0);
        float[] specularLight = {1.0f, 1.0f, 1.0f, 0.0f};  // specular 
        ...
        this.textura2 = this.cargarTextura("imagenes/iconoAI.jpg");
    ...
    void setSomeYellowMaterial(GL2 gl, int face) {
